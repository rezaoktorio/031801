...
<div class="container">
	...
	<div class="col-lg-4">
		<?php 
			if (!empty($_GET['message']) && $_GET['message'] == 'success') {
				echo '<center><h3>Data berhasil di-update !</h3></center>';
		...
		<center><br><h5><a href="//localhost/nikitalaundry_member/utama/">Lihat Data</a></h5></center>
	</div>
	<div class="col-lg-4"></div>
</div>
    ...
    <div id="footer">
      <div class="container">
        <p class="text-muted">Nikita Laundry || Membership</p>
      </div>
    </div>
