...
<div class="row">
    <div class="col-sm-10 col-sm-offset-1">
        ...
        <h4 class='page-title' style="margin-top: 0px">Menu Upload Data Agama</h4>
...
<div class="row">
  <div class="col-sm-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <i class="fa fa-arrow-circle-right"></i> Menu Upload Data Agama
            </li>
        </ol>
			</div>
        ...
        <div class="col-sm-12">
          <div class="col-sm-12">
            <div class="m-b-30">
                <a href="#custom-modal-agama" data-animation="flash" data-plugin="custommodal"
              ...
              <div class="card-box table-responsive">
                  <h5 class="m-t-0 header-title"><b>Daftar Data Agama.</b></h5>
