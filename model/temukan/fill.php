...
<div class="row">
  ...
  <div class="col-sm-12">
        ...
        $query = mysql_query("SELECT
                markers.name as nama_kecamatan, markers.embed as embed, markers.address as alamat, markers.luas_wilayah as luas_wilayah, markers.telepon_kecamatan as telepon_kecamatan,
        ...
        ?>
          ...
          if (mysql_num_rows($query) == 1) {
            ...
            <div class="col-sm-5">
              <iframe src="https://www.google.com/maps/embed?<?php echo $data['embed'];?>" width="400" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>
            </div>
            <div class="col-sm-7">
              <div class="col-sm-6">
                <center>
              ...
              <div class="col-sm-6">
                <center>
                  <h4 class="panel-title">Informasi Singkat</h4><br>
                  <table class="table">
                    <tr>
                      <td>Luas Wilayah</td>
                    ...
                    <tr>
                      <td>Alamat</td>
                      <td><?php echo $data['alamat'];?><br><?php echo $data['telepon_kecamatan'];?></td>
                    </tr>
                  </table>
                  <a class="btn btn-info" href="../../view/dashboard_1/index.php?id=25">Dashboard</a>
                </center>
              </div>
            </div>
            <?php
