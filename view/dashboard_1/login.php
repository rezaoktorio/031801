...
<html>
<head>
<title>Aplikasi Membership || Nikita Laundry</title>
...
if (!empty($_GET['error'])) {
  if ($_GET['error'] == 1) {
    ...
    echo '<center><h3>Karyawan tidak terdaftar!</h3></center>';
  }
}
?>
...
<div class="col-lg-6 col-md-6" style="padding-top:10%;border:solid black 0px;background:;">
  <div class="col-lg-12 col-md-12" style="border-top:solid black 0px;background:#34495E;">
    <center>
        <font color="#4ECDC4"><h3><i class="fa fa-paw"></i>Aplikasi Membership Nikita Laundry</h3></font>
      </center>
  </div>
  ...
  <div class="col-lg-12 col-md-12" style="color:#34495E;border-top:solid #34495E 1px;margin-top:2%">
    <center>
        <h1><i class="fa fa-paw"></i>Nikita Laundry</h1>
        <p>Aplikasi Membership<br>Jl. Kasatryan 001 01/02 Glagah, Karangan, Balong, Ponorogo, Jawa Timur<br>2017 © All Rights Reserved.</p>
      </center>
  </div>
</div>
<div class="col-lg-3 col-md-3" style="padding-top:12%;border:solid black 0px;">
