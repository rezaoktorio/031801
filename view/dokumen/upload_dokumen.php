...
<?php
//include "../../controller/excel_reader2.php";
$username = "root";
$password = "";
$database = "sig";
...
$query = "INSERT INTO dokumen VALUES ('','$data2','$data3', '$data4', '$data5','$data6','$data7','$data8', '$data9', '$data10', '$data11', '$data12', '$data13', '$data14')";
...
<div class="container">
	...
	<div class="col-lg-4">
		...
		<center><br><h5><a href="//localhost/SIG_Dukcapil/view/dokumen">Menu Utama</a></h5></center>
	</div>
	<div class="col-lg-4"></div>
</div>
    ...
    <div id="footer">
      <div class="container">
        <p class="text-muted">Aplikasi SIG</p>
      </div>
    </div>
